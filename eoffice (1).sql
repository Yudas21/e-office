...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2018 at 12:13 PM
...
INSERT INTO `divisi` (`id`, `name`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Information Technology', NULL, NULL, NULL),
(2, 'General', NULL, NULL, NULL);
...
(2, 'Supervisor', NULL, NULL, NULL),
(3, 'Manager', NULL, NULL, NULL),
(4, 'Sekertaris', NULL, NULL, NULL),
(5, 'Direktur', NULL, NULL, NULL),
(6, 'Owner', NULL, NULL, NULL),
(7, 'Administrator', NULL, NULL, NULL);
...
INSERT INTO `menu` (`id`, `name`, `icon`, `url`, `parent`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Dashboard', 'fa fa-tachometer', '', 0, NULL, NULL, NULL),
(2, 'User Management', 'fa fa-users', '', 0, NULL, NULL, NULL),
(3, 'Menu', '', 'admin/menu', 2, NULL, NULL, NULL),
(4, 'Level', '', 'admin/level', 2, NULL, NULL, NULL),
(5, 'Divisi', '', 'admin/divisi', 2, NULL, NULL, NULL),
(6, 'Users', '', 'admin/users', 2, NULL, NULL, NULL),
(7, 'Master Surat', '', '', 0, NULL, NULL, NULL);
...
(8, '2018_04_10_021239_create_articles_table', 3);
