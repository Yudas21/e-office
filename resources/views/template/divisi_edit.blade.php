        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Form Update Divisi</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(1)">User Management</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(2)">Divisi</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('admin/update_divisi/'.$divisi->id) }}" method="post">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control col-md-4" name="parent">
                                        <option value="0" {{ $divisi->parent == 0 ? 'selected' : '' }}>as Parent</option>
                                        @foreach ($parent as $d_parent) 
                                            <option value="{{ $d_parent->id }}" {{ $d_parent->id == $divisi->parent ? 'selected' : '' }}>{{ $d_parent->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
